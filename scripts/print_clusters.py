...
def main():
    ...
    missing = 0
    for cluster in clusters:
        if cluster.family == None:
            missing += 1
            print cluster.name
            for member in cluster.members:
                if member.family == None:
                    print member.gene_name, member.domains, member.family
    print "Total of "+ str(missing) +"clusters have no assigned family"
